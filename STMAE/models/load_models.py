...
from models.pfmodels.pf_gwnet import GWNET, GWNET_Decoder
from models.pfmodels.pf_mtgnn import MTGNN, MTGNN_Decoder

from models.blmodels.bl_agcrn import AGCRN_BL
from models.blmodels.bl_dcrnn import DCRNN_BL
from models.blmodels.bl_gwnet import GWNET_BL
from models.blmodels.bl_mtgnn import MTGNN_BL
...
def get_baseline(cfg, adj=None, device=torch.device('cpu')):
    model_name = cfg.backbone
    if model_name == 'agcrn':
        model = AGCRN_BL(
            num_nodes=cfg.num_nodes, 
