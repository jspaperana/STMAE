...
class Config:
    ...
    def __init__(self, cfg_id, date=None):
        ...
        # gwnet
        self.gwnet_drop = self.backbone_specs.get('gwnet_drop', 0.3)
        self.gcn_bool = self.backbone_specs.get('gcn_bool', True)
        self.addaptadj = self.backbone_specs.get('addaptadj', True)
        self.aptinit = self.backbone_specs.get('aptinit', None)
        # mtgnn
        ...
        # # learning
        # if joint, only use below parameters
        ...
        # # STGCL specific configs
        self.stgcl_specs = cfg.get('stgcl_specs', dict())
        self.fn_t = self.stgcl_specs.get('fn_t', 12)
        self.em_t = self.stgcl_specs.get('em_t', 0)
        self.im_t = self.stgcl_specs.get('im_t', 0.01)
        self.ts_t = self.stgcl_specs.get('ts_t', 0)
        self.ism_t = self.stgcl_specs.get('ism_t', 0)
        self.ism_e = self.stgcl_specs.get('ism_e', 20)
        self.tempe = self.stgcl_specs.get('tempe', 0.1)
        self.lam = self.stgcl_specs.get('lam', 0.1)
